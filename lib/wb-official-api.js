...
/**
 * Комиссии WB по subjectID: FBO (kgvpMarketplace) и FBS (kgvpSupplier), доли 0..1.
 * FBS в калькуляторе = kgvpSupplier + надбавка за часы доставки (см. fbs-commission.js).
