...
export const DEFAULT_UNIT_SETTINGS = {
  ...
  taxRate: 0.06,
  /** wb_portal — УСН с прибыли до налога (как калькулятор WB); revenue — с цены продажи */
...
export function migrateStoredSettings(raw) {
  ...
  return normalizeLegacySettings({ ...DEFAULT_UNIT_SETTINGS, ...raw, taxBaseMode: raw.taxBaseMode || 'wb_portal' });
}
