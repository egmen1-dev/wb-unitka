...
- **Отзывы WB** — вынесены в отдельный сервис [wb-feedbacks](https://wb-feedbacks.vercel.app) (вкладка «Отзывы» → ссылка)
...
- Отзывы: `../wb-feedbacks/` — отдельный деплой, см. [wb-feedbacks/README.md](../wb-feedbacks/README.md)
